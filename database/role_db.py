...
new_user = User(name='Bob',sex='男',pwd=hash('123456'),phone='13243434434',card_number='102312',organization='如家酒店', email='13142341@qq.com',is_activated='True',create_date=time,create_by='SuperUser',status='开启')
# 添加到session:
